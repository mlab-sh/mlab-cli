...
assets. It is
[`.github/workflows/release.yml`](https://github.com/mlab-sh/mlab-cli/blob/main/.github/workflows/release.yml),
...
[`ci.yml`](https://github.com/mlab-sh/mlab-cli/blob/main/.github/workflows/ci.yml),
...
The glob is `mlab*` rather than `mlab-*`, because cargo-deb names its output
...
These pages live in [`wiki/`](https://github.com/mlab-sh/mlab-cli/tree/main/wiki)
in this repository and are mirrored to the GitHub wiki by
[`wiki-sync.yml`](https://github.com/mlab-sh/mlab-cli/blob/main/.github/workflows/wiki-sync.yml)
